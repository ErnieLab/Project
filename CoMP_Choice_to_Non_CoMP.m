% ============================================================================================== %
% 該function是用來讓**CoMP**的UE，看看離開CoMP後的Throughput，是否有滿足QoS，再來決定要不要換    %
% ============================================================================================== %

function [BS_RB_table_output, BS_RB_who_used_output, UE_RB_used_output, idx_UEcnct_TST_output, idx_UEcnct_CoMP_output, UE_CoMP_orNOT_output, UE_throughput_After_take] = CoMP_Choice_to_Non_CoMP(n_MC, n_PC, BS_RB_table, BS_RB_who_used, UE_RB_used, AMP_Noise, n_ttoffered, Pico_part, RsrpBS_Watt, ...
																																															     idx_UE, Serving_Cell_index, Cooperating_Cell_index, UE_throughput, GBR, BW_PRB, idx_UEcnct_CoMP)
...
if UE_throughput_if_leave_CoMP >= GBR
	...
	UE_throughput_After_take = UE_throughput_if_leave_CoMP;
else
	...
	idx_UEcnct_CoMP          = temp_idx_UEcnct_CoMP;
