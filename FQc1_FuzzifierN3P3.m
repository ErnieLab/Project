	...
	switch(type)
        case 'C'	% 'C' means CIO
            ...
            if(FQ_INP < -3)
                ...
                subDoM(4) = 0; 
                subDoM(5) = 0;
            elseif(FQ_INP >= -3 && FQ_INP < -1.5)
                subDoM(1) = -(2/3)*FQ_INP-1; 
                subDoM(2) =  (2/3)*FQ_INP+2; 
                subDoM(3) =  0; 
                subDoM(4) =  0; 
                subDoM(5) =  0;
            elseif(FQ_INP >= -1.5 && FQ_INP < 0)
                subDoM(1) =  0; 
                subDoM(2) = -(2/3)*FQ_INP; 
                subDoM(3) =  (2/3)*FQ_INP+1; 
                subDoM(4) =  0; 
                subDoM(5) =  0;
            elseif(FQ_INP >= 0 && FQ_INP < 1.5)
                subDoM(1) =  0; 
                subDoM(2) =  0; 
                subDoM(3) = -(2/3)*FQ_INP+1; 
                subDoM(4) =  (2/3)*FQ_INP; 
                subDoM(5) =  0;
            elseif(FQ_INP >= 1.5 && FQ_INP < 3)
                subDoM(1) =  0; 
                subDoM(2) =  0; 
                subDoM(3) =  0; 
                subDoM(4) = -(2/3)*FQ_INP+2; 
                subDoM(5) =  (2/3)*FQ_INP-1;
            elseif(FQ_INP >= 3)
                subDoM(1) =  0; 
                subDoM(2) =  0; 
                subDoM(3) =  0; 
